...
> Если этого не сделать, вместо скоростного соединения по **WebSocket** будет происходить фоллбек (fallback) на обычное **TCP-соединение**, что в общем не гарантирует никаких преемуществ.
