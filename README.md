...
Из-за смены релизной подписи приложения, поверх старой версии это обновление не встанет. **Вам необходимо полностью удалить предыдущую версию перед установкой новой** (приношу свои извинения!).
