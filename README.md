...
> Если этого не сделать, вместо скоростного соединения по **WebSocket** будет происходить фоллбек (fallback) на обычное **TCP-соединение**, что сведет все преимущества прокси к нулю.

## 🌟 Что нового в Android-версии

В отличие от консольной утилиты, функции управления вынесены в красивый и удобный **Material 3** интерфейс (Jetpack Compose), без лишней «хуйни», без предупреждений антивирусов (никаких ложных Wacatac-детектов) и без лишних зависимостей.
