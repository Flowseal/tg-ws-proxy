...
Для Arch и Arch-based дистрибутивов есть пакет в [AUR](https://aur.archlinux.org/packages/tg-ws-proxy-bin). Можете использовать любой AUR-helper помимо paru.
```bash
